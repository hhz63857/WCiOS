...
static NSString * const kConsumerKey       = @"YRXZY0VEzG-lA8m-EU6o5w";
static NSString * const kConsumerSecret    = @"WZdneNss7ZcWcPL8EG8hCZG4jBI";
static NSString * const kToken             = @"JV13CNVVMwmtKuW3KZJY4LiP7huKOw-3";
static NSString * const kTokenSecret       = @"WBX3QsITOWuiCwlk8zTwU9a79d4";
